					...
					>
						...
						>
							<li className="nav-item">
								<NavLink className="fs-14 fw-semibold" href="#hero">
									Home
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink className="fs-14 fw-semibold" href="#wallet">
									Wallet
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink className="fs-14 fw-semibold" href="#marketplace">
									Marketplace
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink className="fs-14 fw-semibold" href="#categories">
									Categories
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink className="fs-14 fw-semibold" href="#creators">
									Creators
								</NavLink>
							</li>
						</Scrollspy>
