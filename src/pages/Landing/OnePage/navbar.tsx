					...
					>
						...
						>
							<li className="nav-item">
								<NavLink href="#hero" className="fs-15 fw-semibold">
									Home
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink href="#services" className="fs-15 fw-semibold">
									Services
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink href="#features" className="fs-15 fw-semibold">
									Features
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink href="#plans" className="fs-15 fw-semibold">
									Plans
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink href="#reviews" className="fs-15 fw-semibold">
									Reviews
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink href="#team" className="fs-15 fw-semibold">
									Team
								</NavLink>
							</li>
							<li className="nav-item">
								<NavLink href="#contact" className="fs-15 fw-semibold">
									Contact
								</NavLink>
							</li>
						</Scrollspy>
