...
const StartupProfileCard: React.FC<StartupProfileCardProps> = ({ startup, onOpenVideo }) => {
  const progressPercent = Math.round((startup.currentInvestment / startup.investmentGoal) * 100);
  const approvalClass = startup.publicApproval >= 80 ? "approval-high" : startup.publicApproval >= 60 ? "approval-medium" : "approval-low";
      ...
      <CardBody className="p-0">
            ...
            >
              ...
              <div className="position-absolute bottom-0 start-0 end-0 p-2 text-center card-video-overlay-bottom">
                <small className="text-white card-video-label">
                  <i className="ri-video-line me-1"></i><span className="d-none d-sm-inline">Pitch </span>Video
                </small>
              </div>
            </div>
          </Col>
        ...
        <div className="card-content">
          ...
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <Badge className="card-sector-badge">
              {startup.sector}
            </Badge>
          </div>
          ...
          <div className="d-flex justify-content-between align-items-center mb-3 p-2 rounded card-min-investment">
            ...
            <span className="fw-bold value">${startup.minInvestment.toLocaleString()}</span>
          </div>
          ...
          <div className="public-approval-section text-center p-2 p-sm-3 mb-2 mb-sm-3">
            ...
            <div className="d-flex align-items-center justify-content-center gap-1 mb-2 mb-sm-3">
              ...
              <small className="text-muted votes-text">{startup.totalVotes.toLocaleString()} votes</small>
            </div>

            {/* PREMIUM VOTE BUTTON */}
            <Button className="btn-vote w-100 d-flex align-items-center justify-content-center gap-1 gap-sm-2">
              <i className="ri-thumb-up-fill vote-icon"></i>
              <span className="vote-btn-text">Vote<span className="d-none d-sm-inline"> for this Startup</span></span>
            </Button>
          </div>

          {/* PROPOSAL Button */}
          <Button className="w-100 btn-proposal">
