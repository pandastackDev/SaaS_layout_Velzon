...
import { statuses, countries, categories, cities, investmentRanges, equityRanges } from "./data";
...
const InvestmentOpportunities: React.FC<InvestmentOpportunitiesProps> = ({ startups, onOpenVideo }) => {
  ...
  const filteredStartups = startups.filter((startup) => {
    const matchesCategory = selectedCategory === "All Categories" || startup.sector === selectedCategory;
    const matchesCountry = selectedCountry === "All Countries" || startup.country === selectedCountry;
    ...
    <div className="investment-opportunities">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted mb-0 section-subtitle">Discover promising startups seeking investment</p>
        </div>
      ...
      <Card className="border-0 mb-3 mb-md-4 filter-card">
        <CardBody className="py-2 py-md-3 px-2 px-md-3">
          ...
          <div className="filter-bar-desktop d-none d-xl-flex align-items-center gap-2 flex-wrap">
            ...
            {/* Reset */}
            <Button outline color="secondary" className="btn-reset" onClick={resetFilters}>
          ...
          <div className="filter-bar-mobile d-xl-none">
            ...
            <Row className="g-2 align-items-center">
              ...
              <Col xs={6} sm={3}>
                <Button outline color="secondary" className="w-100 btn-reset" onClick={resetFilters}>
                  <i className="ri-refresh-line me-1"></i>Reset
                </Button>
              </Col>
            </Row>
