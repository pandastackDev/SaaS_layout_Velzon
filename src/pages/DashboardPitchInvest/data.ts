import { Startup, Announcement, FeaturedStartupProfile, FeaturedInvestor } from "./types";
...
export const mockStartups: Startup[] = [
  {
    ...
    photo: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=400&h=300&fit=crop",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=400&h=300&fit=crop",
    video: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    country: "Germany",
    countryFlag: "🇩🇪",
    sector: "Clean Energy",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&h=300&fit=crop",
    video: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    country: "Brazil",
    countryFlag: "🇧🇷",
    sector: "Education",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=400&h=300&fit=crop",
    video: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    country: "Netherlands",
    countryFlag: "🇳🇱",
    sector: "Agriculture",
...
export const featuredInvestor: FeaturedInvestor = {
  ...
  description: "Looking for early-stage Fintech startups with innovative payment solutions, blockchain technology, or digital banking platforms. I prefer companies with a clear revenue model.",
  portfolio: [
    { name: 'Portfolio 1', image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=200&h=200&fit=crop' },
    { name: 'Portfolio 2', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=200&h=200&fit=crop' },
    { name: 'Portfolio 3', image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=200&h=200&fit=crop' },
    { name: 'Portfolio 4', image: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=200&h=200&fit=crop' },
    { name: 'Portfolio 5', image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=200&h=200&fit=crop' },
    { name: 'Portfolio 6', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=200&h=200&fit=crop' },
  ],
};
...
// FILTER OPTIONS
// ============================================
export const sectors = ["All Sectors", "Technology", "Clean Energy", "Healthcare", "FinTech", "Education", "Agriculture"];
export const countries = ["All Countries", "United States", "Germany", "United Kingdom", "Singapore", "Brazil", "Netherlands"];
export const statuses = ["All Status", "Active", "Funding", "Completed", "Pending", "Closed"];
export const categories = ["All Categories", "Technology", "Healthcare", "Clean Energy", "FinTech", "Education", "Agriculture", "Real Estate", "Manufacturing"];
export const cities = ["All Cities", "New York", "San Francisco", "London", "Berlin", "Singapore", "Dubai", "São Paulo", "Amsterdam"];
export const investmentRanges = ["All Ranges", "$0 - $50K", "$50K - $100K", "$100K - $250K", "$250K - $500K", "$500K+"];
export const equityRanges = ["All %", "1% - 5%", "5% - 10%", "10% - 20%", "20% - 30%", "30%+"];
