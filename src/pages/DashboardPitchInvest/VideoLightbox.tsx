...
const VideoLightbox: React.FC<VideoLightboxProps> = ({ isOpen, toggle, startup }) => {
  if (!startup) return null;

  return (
    <Modal isOpen={isOpen} toggle={toggle} centered size="lg" className="video-lightbox-modal">
