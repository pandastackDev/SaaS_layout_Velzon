...
const FeaturedCarousel: React.FC<FeaturedCarouselProps> = ({ startups, onOpenVideo }) => {
  ...
  const handleManualNav = (direction: "next" | "prev") => {
    ...
    if (direction === "next") {
      ...
      setActiveIndex((prev) => (prev - 1 + featuredStartups.length) % featuredStartups.length);
    }
  };
  ...
  const approvalClass = currentStartup.publicApproval >= 90 ? "approval-high" : currentStartup.publicApproval >= 70 ? "approval-medium" : "approval-low";
      ...
      <CardBody className="p-2 p-sm-3 p-md-4">
        <div className="d-flex justify-content-between align-items-center mb-3 mb-md-4 flex-wrap gap-2">
          ...
          {!isAutoPlaying ? (
            ...
            <Badge color="success" className="d-flex align-items-center gap-1 control-badge">
              <span className="pulse-dot"></span> <span className="d-none d-sm-inline">Auto-playing</span>
            </Badge>
          )}
        </div>
          ...
          <Col lg={3} md={6} className="d-none d-lg-block">
            <Card className="h-100 border-0 position-relative profile-card">
              ...
              <div
                ...
                style={{ backgroundImage: `url(${featuredStartupProfile.coverImage})` }}
              >
              ...
              <CardBody className="p-3 profile-body">
                ...
                <div className="mb-3 profile-info">
                  <div className="mb-1">
                    <span className="fw-semibold">Name:</span> {featuredStartupProfile.name}
                  </div>
                  <div className="mb-1">
                    <span className="fw-semibold">Startup:</span> {featuredStartupProfile.projectName}
                  </div>
                  <div className="mb-1">
                    <span className="fw-semibold">Cidade:</span> {featuredStartupProfile.city}
                  </div>
                  <div className="d-flex align-items-center gap-2 mb-1">
                    <span className="fw-semibold">País:</span>
                    <span>{featuredStartupProfile.country} {featuredStartupProfile.countryFlag}</span>
                  </div>
                </div>

                <div className="d-flex gap-2 mb-3">
                  <Button size="sm" className="flex-fill btn-message">Message</Button>
                  <Button size="sm" className="flex-fill btn-proposal-outline">Proposal</Button>
                </div>

                <div className="text-center mb-3">
                  <div className="fw-bold capital-info">
                    {featuredStartupProfile.capitalPercentage}% por {featuredStartupProfile.capitalTotalValue}
                  </div>
                ...
                <Row className="g-2 mb-3">
                  ...
                  <Col xs={6}>
                    ...
                    >
                      <img src={featuredStartupProfile.photos[0]} alt="Video thumbnail" />
                ...
                <div className="text-center p-3 mt-auto profile-stats-section">
                  ...
                  <div className="fw-bold mb-2 text-success" style={{ fontSize: "1.5rem" }}>
                        ...
                        <div className="position-relative carousel-frame">
                          ...
                          <div className="position-absolute bottom-0 start-0 w-100 p-2 p-md-3 carousel-overlay-bottom">
                            <p className="text-white-50 small mb-0 country-text">
                              {currentStartup.countryFlag} <span className="d-none d-sm-inline">{currentStartup.country}</span>
                            </p>
                          </div>
                        </div>
                      </Col>
                      <Col xs={6} md={6}>
                        ...
                        >
                          <div className="text-center px-2">
                            ...
                            <h6 className="text-white mb-1 mb-md-2 video-cta-text">🎥 <span className="d-none d-sm-inline">Watch</span> Pitch Video</h6>
                            <p className="text-white-50 small mb-0 d-none d-md-block">Click to play</p>
                          </div>
                        </div>
                      </Col>
                    </Row>
                    ...
                    <div className="p-2 p-md-3 d-flex justify-content-between align-items-center flex-wrap gap-2 quick-info-bar">
                      <div className="d-flex align-items-center gap-2 gap-md-3 flex-wrap">
                        ...
                        <Badge className={`approval-badge ${approvalClass}`}>
                          {currentStartup.publicApproval}% <span className="d-none d-sm-inline">Approval</span>
                        </Badge>
                        <span className="small fw-bold raised-amount">
                          €{(currentStartup.currentInvestment / 1000).toFixed(0)}K <span className="d-none d-sm-inline">Raised</span>
                        </span>
                      </div>
            ...
            <Card className="h-100 border-0 position-relative profile-card">
              ...
              <CardBody className="p-3 d-flex flex-column profile-body">
                ...
                <div className="text-end mb-2">
                  <h5 className="mb-0" style={{ fontSize: "0.85rem", fontWeight: 600 }}>
                ...
                <div className="mb-3 profile-info">
                  <div className="mb-1">
                    <span className="fw-semibold">Type:</span> {featuredInvestor.role}
                  </div>
                  <div className="mb-1">
                    <span className="fw-semibold">Company:</span> {featuredInvestor.company}
                  </div>
                  <div className="mb-1">
                    <span className="fw-semibold">Focus:</span> Fintech & Innovation
                  </div>
                </div>
                ...
                <div className="d-flex gap-2 mb-3">
                  <Button size="sm" className="flex-fill btn-message">Message</Button>
                  <Button size="sm" className="flex-fill btn-profile-outline">View Profile</Button>
                </div>

                {/* Investment Stats */}
                <div className="text-center mb-3">
                  <div className="fw-bold capital-info">6 Portfolio Companies</div>
                  <div className="text-success fw-bold small">Active Investor</div>
                </div>
                ...
                <div className="mb-3">
                  <Row className="g-2">
                    <Col xs={6}>
                      <div className="bg-white rounded d-flex align-items-center justify-content-center overflow-hidden profile-video-thumbnail" style={{ border: "1px solid #e0e0e0" }}>
                        <img
                    ...
                    <Col xs={6}>
                      <div
                        ...
                        onClick={() => onOpenVideo(currentStartup)}
                      >
                        <img src={featuredInvestor.portfolio[0].image} alt="Video thumbnail" />
                        <div className="position-absolute top-50 start-50 translate-middle d-flex align-items-center justify-content-center play-btn-small">
                          <i className="ri-play-fill"></i>
                        </div>
                      </div>
                ...
                <div className="text-center p-3 mt-auto profile-stats-section">
                  ...
                  <div className="d-flex justify-content-center gap-2">
                    <div className="text-center px-2">
                      <div className="fw-bold" style={{ fontSize: "1.2rem", color: "#0a3d62" }}>6</div>
                      <div className="text-muted" style={{ fontSize: "0.7rem" }}>Portfolio</div>
                    </div>
                    <div className="text-center px-2">
                      <div className="fw-bold text-success" style={{ fontSize: "1.2rem" }}>95%</div>
                      <div className="text-muted" style={{ fontSize: "0.7rem" }}>Success</div>
                    </div>
                  </div>
                </div>
              </CardBody>
