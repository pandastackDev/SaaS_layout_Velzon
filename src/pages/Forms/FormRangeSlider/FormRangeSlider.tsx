...
const FormRangeSlider = () => {
	...
	const pipsOptions = {
		...
		density: 4,
		format: {
			to: (value: any) => parseInt(value, 10),
								...
								<div className="live-preview">
									<div>
										...
										<div className="mt-4">
											...
											<p className="text-muted">
												Use <code>disabled</code> attribute on an input to give
										...
										<div className="mt-4">
											...
											<p className="text-muted">
												Use <code>min</code> and <code>max</code> attribute with
												specified range input respectively.
											</p>
									...
									<Col xl={4} lg={6}>
										<div>
											...
											<p className="text-muted mb-4">
												Use{" "}
												<code>
													data-rangeslider data-slider-color=&quot;primary&quot;
												</code>{" "}
									...
									<Col xl={4} lg={6}>
										<div className="mt-4 mt-xl-0">
											...
											<p className="text-muted mb-4">
												Use{" "}
												<code>
													data-rangeslider data-slider-color=&quot;success&quot;
												</code>{" "}
									...
									<Col xl={4} lg={6}>
										<div className="mt-4">
											...
											<p className="text-muted mb-4">
												Use{" "}
												<code>
													data-rangeslider data-slider-color=&quot;danger&quot;
												</code>{" "}
