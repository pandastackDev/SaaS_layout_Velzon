				...
				<Container fluid>
							...
							<Card className="overflow-hidden shadow-none">
								<CardBody className="bg-success-subtle text-success fw-semibold d-flex">
									<div className="fs-14 marquee">
										...
										non-transferrable, Cortes explained. Every NFT is unique in
										its creative design and cannot be duplicated, making them
										limited and rare. NFTs get their value because the
					...
					<Row>
						<Col lg={12}>
							<div className="d-lg-flex align-items-center mb-4">
								<div className="flex-grow-1">
									<h5 className="card-title mb-0 fw-bold fs-16">
										Popular Creators
									</h5>
								</div>
								<div className="flex-shrink-0 mt-4 mt-lg-0">
