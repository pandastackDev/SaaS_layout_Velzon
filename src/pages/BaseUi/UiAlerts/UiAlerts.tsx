									...
									<div className="live-preview">
										<Row>
											<Col xl={6}>
												<h6>Primary Alert</h6>
												<UncontrolledAlert
													className="bg-primary text-white alert-solid alert-label-icon"
												...
												<h6>Secondary Alert</h6>
												<UncontrolledAlert
													className="bg-secondary text-white alert-solid alert-label-icon"
													closeClassName="btn-close-white"
												>
												...
												<h6>Success Alert</h6>
												<UncontrolledAlert
													className="bg-success text-white alert-solid alert-label-icon"
													closeClassName="btn-close-white"
												>
												...
												<h6>Danger Alert</h6>
												<UncontrolledAlert
													className="bg-danger text-white alert-solid alert-label-icon mb-xl-0"
													closeClassName="btn-close-white"
												>
											...
											<Col xl={6}>
												<h6>Warning Alert</h6>
												<UncontrolledAlert
													className="bg-warning text-white alert-solid alert-label-icon"
													closeClassName="btn-close-white"
												>
												...
												<h6>Info Alert</h6>
												<UncontrolledAlert
													className="bg-info text-white alert-solid alert-label-icon"
													closeClassName="btn-close-white"
												>
												...
												<h6>Light Alert</h6>
												<UncontrolledAlert
													className="bg-light text-body alert-solid alert-label-icon"
													closeClassName="btn-close-white"
												>
												...
												<h6>Dark Alert</h6>
												<UncontrolledAlert
													className="bg-dark text-white alert-solid alert-label-icon mb-0"
													closeClassName="btn-close-white"
												>
									...
									<div className="live-preview">
										<Row>
											<Col xl={6}>
												...
												<Alert
													color="danger"
													className="bg-danger border-danger text-white mb-xl-0"
												>
											...
											<Col xl={6}>
												...
												<Alert
													color="light"
													className="bg-light border-light text-body"
												>
												...
												<Alert
													color="dark"
													className="bg-dark border-dark text-white mb-0"
												>
